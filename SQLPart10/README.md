...
| |
|-|
| Изучи один из известных паттернов баз данных — "Аномалия потери обновления" (Lost Update Anomaly). 
...
| |
|-|
| Изучи один из известных паттернов баз данных — "Аномалию потери обновления" (Lost Update Anomaly), но на уровне изоляции REPEATABLE READ. 
...
| |
|-|
| Давай проверим один из известных паттернов баз данных — "Неповторяющееся чтение" (Non-Repeatable Reads), но на уровне изоляции READ COMMITTED. 
...
| |
|-|
| Давай проверим один из известных паттернов баз данных — "Неповторяющееся чтение" (Non-Repeatable Reads), но на уровне изоляции SERIALIZABLE. 
...
| |
|-|
| Давай рассмотрим один из известных паттернов баз данных — "Фантомное чтение" (phantom reads), но на уровне изоляции READ COMMITTED. 
...
| |
|-|
| Давай рассмотрим один из известных паттернов баз данных — "Фантомное чтение" (Phantom Reads), но на уровне изоляции REPEATABLE READ. 
